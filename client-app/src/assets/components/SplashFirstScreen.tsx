    ...
    return (
        <>
            ...
            <div id="splash-first-access">
                ...
                <div>
                    <button onClick={showNewAssetPage} className="btn border btn-primary rounded-4 shadow-sm btn-lg px-3 py-3 w-100 d-flex gap-3 justify-content-center border-0">
